            ...
            <Card>
              <CardContent className="flex items-start gap-4 p-6">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">laundrybacket@gmail.com</p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardContent className="flex items-start gap-4 p-6">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground mt-1">Laundry Lane</p>
                  <p className="text-muted-foreground">Juja (Gate C- Jkuat), Kiambu</p>
                </div>
              </CardContent>
            </Card>
