    ...
    <header className="sticky top-0 z-50 bg-white shadow-sm">
      <div className="container py-4 flex justify-between items-center">
        ...
        <nav className="hidden md:flex items-center space-x-8">
          ...
          <Link href="/products" className="text-foreground hover:text-blue-800 transition-colors">
            Products
          </Link>
      ...
      {isOpen && (
        ...
        >
          <div className="container flex flex-col space-y-4">
            ...
            <Link href="/products" className="text-foreground hover:text-blue-800 transition-colors" onClick={toggleMenu}>
              Products
            </Link>
            ...
            <div className="flex space-x-4 pt-2">
              {user ? (
                <Link href="/dashboard" className="w-full">
                  <Button className="w-full" onClick={toggleMenu}>Dashboard</Button>
                </Link>
              ) : (
                <>
